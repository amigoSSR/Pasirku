<x-layout-store title="Pengaturan Toko">
    <div class="px-6 md:px-8">
        ...
        <header class="mb-8">
            ...
            <p class="text-on-surface-variant dark:text-zinc-400 text-sm mt-1.5">Kelola preferensi akun dan tampilan dashboard Anda.</p>
        </header>
        ...
        <div class="max-w-3xl space-y-6">
            ...
            <section class="bg-surface-container-lowest dark:bg-zinc-900 rounded-2xl p-6 border border-outline-variant/30 dark:border-zinc-800 shadow-sm opacity-60">
                <div class="flex items-center gap-3 mb-6">
                    <div class="w-10 h-10 bg-surface-container dark:bg-zinc-800 rounded-xl flex items-center justify-center text-outline dark:text-zinc-500">
                        <span class="material-symbols-outlined text-[22px]">notifications</span>
                    </div>
                    <div>
                        <h2 class="font-headline font-bold text-on-surface dark:text-zinc-100">Notifikasi</h2>
                        <p class="text-on-surface-variant dark:text-zinc-400 text-xs text-primary dark:text-primary-fixed font-bold uppercase tracking-widest text-[10px]">Segera Hadir</p>
                    </div>
                </div>
                <div class="h-24 flex items-center justify-center border-2 border-dashed border-outline-variant/20 dark:border-zinc-800 rounded-xl text-xs text-outline italic">
                    Pengaturan notifikasi sedang dalam pengembangan.
                </div>
            </section>
        </div>
    </div>
