  ...
  <header
    ...
    <div class="flex justify-between items-center w-full px-6 py-3 max-w-7xl mx-auto">
      <div class="flex items-center gap-8">
        <span class="text-xl font-black tracking-tighter text-blue-900 dark:text-blue-100 uppercase">QUARRY
          DIRECT</span>
        <!-- Desktop Nav Cluster -->
      ...
      <div class="flex items-center gap-4">
        <div class="hidden sm:flex relative items-center">
          <input
            ...
            placeholder="Search quarries..." type="text" />
    ...
    <main class="flex-1 md:ml-64 flex flex-col md:flex-row overflow-hidden bg-surface">
      ...
      <section
        ...
        <header class="mb-2">
          ...
          <h1 class="text-3xl font-extrabold text-on-surface tracking-tighter leading-none">
            Nearby Sand Deposits
          </h1>
        </header>
        <!-- Shop Filter Tabs -->
        <div class="flex gap-2 mb-2 overflow-x-auto pb-2">
          <button class="bg-primary text-white px-4 py-1.5 rounded-full text-xs font-bold whitespace-nowrap">
            All Grades
          </button>
          <button
            class="bg-white text-on-surface-variant px-4 py-1.5 rounded-full text-xs font-bold whitespace-nowrap hover:bg-surface-container-high transition-colors">
            Concrete Sand
          </button>
          <button
            class="bg-white text-on-surface-variant px-4 py-1.5 rounded-full text-xs font-bold whitespace-nowrap hover:bg-surface-container-high transition-colors">
        ...
        <div class="grid gap-4">
          <!-- Shop Card 1 -->
          <div
            class="bg-surface-container-lowest p-5 rounded-xl shadow-[0px_4px_20px_rgba(0,0,0,0.02)] group hover:translate-y-[-2px] transition-all cursor-pointer">
      ...
      <script>
        ...
        function getPosition(position) {
          ...
          marker = L.marker([lat, lon, accuracy]).addTo(map);
          map.setView([lat, lon, accuracy], 16);
        }
      </script>
