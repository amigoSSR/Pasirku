...
<title>Masuk ke Pasirku - Marketplace Material Bangunan</title>
...
<!-- Left Side: Visual/Branding (Hidden on small mobile if needed, but here as split) -->
...
<h1 class="font-headline-lg text-headline-lg text-on-surface mb-xs">Selamat Datang di Pasirku</h1>
</div>
</div>
<!-- Role Selection -->
...
<!-- Main Form -->
<form class="flex flex-col gap-lg" method="POST" action="{{ route('login') }}">
    @csrf
<!-- Email/Phone Input -->
<div class="flex flex-col gap-xs">
<label class="font-label-md text-label-md text-on-surface-variant" for="Email">Email Toko / Pengguna</label>
...
<input class="w-full pl-[48px] pr-md py-md bg-surface-container-low border border-outline-variant rounded-xl text-on-surface font-body-md focus:outline-none focus:border-primary transition-all" id="Email" name="Email" placeholder="nama@email.com" type="email" value="{{ old('Email') }}" required autofocus autocomplete="username" />
</div>
...
<input class="w-full pl-[48px] pr-[48px] py-md bg-surface-container-low border border-outline-variant rounded-xl text-on-surface font-body-md focus:outline-none focus:border-primary transition-all" id="Password" name="Password" placeholder="Min. 8 karakter" type="password" required autocomplete="current-password" />
...
<input class="w-5 h-5 rounded border-outline-variant text-primary focus:ring-primary/20 cursor-pointer" id="remember_me" name="remember" type="checkbox"/>
<label class="font-body-md text-body-md text-on-surface-variant cursor-pointer select-none" for="remember_me">Ingat saya di perangkat ini</label>
</div>
<!-- Submit Button -->
<button class="w-full py-md bg-primary-container text-on-primary-container font-title-lg text-title-lg rounded-xl soft-shadow hover:brightness-105 active:scale-[0.98] transition-all duration-200" type="submit">
                        Masuk
                    </button>
</form>
<!-- Divider -->
...
<p class="text-center font-body-md text-on-surface-variant">
                    Belum punya akun? <a class="text-primary font-bold hover:underline" href="{{ route('register') }}">Daftar Sekarang</a>
</p>
<!-- Trust Signals -->
